--キメラテック・オーバー・ドラゴン
function c4378.initial_effect(c)
	c:EnableReviveLimit()
	--fusion material
	...
	e3:SetOperation(c4378.sucop)
	c:RegisterEffect(e3)
	local e4=Effect.CreateEffect(c)
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	e4:SetOperation(c4378.tgop)
	c:RegisterEffect(e4)
end
function c4378.sucop(e,tp,eg,ep,ev,re,r,rp)
...
function c4378.tgop(e,tp,eg,ep,ev,re,r,rp)
