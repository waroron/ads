--E・HERO ネオス・ナイト
function c4376.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e2:SetValue(c4376.valcheck)
	c:RegisterEffect(e2)
	local e3=Effect.CreateEffect(c)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e3:SetCode(EVENT_SPSUMMON_SUCCESS)
	e3:SetCondition(c4376.atkcon)
	e3:SetOperation(c4376.atkop)
...
function c4376.atkcon(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(e:GetHandler():GetSummonType(),SUMMON_TYPE_FUSION)==SUMMON_TYPE_FUSION
end
function c4376.atkop(e,tp,eg,ep,ev,re,r,rp)
