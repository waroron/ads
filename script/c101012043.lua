...
function c101012043.initial_effect(c)
	...
	e1:SetCondition(c101012043.spcon)
	...
	e4:SetCountLimit(1,101012043+100)
	e4:SetCost(c101012043.descost)
	e4:SetTarget(c101012043.destg)
	e4:SetOperation(c101012043.desop)
	c:RegisterEffect(e4)
end
function c101012043.valcheck(e,c)
	local ct=e:GetHandler():GetFlagEffectLabel(101012043)
	if not ct then return 0 end
	return ct
end
function c101012043.spcon(e,tp,eg,ep,ev,re,r,rp)
